...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Retorna os dados de um carrinho calculado' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Inicia o fechamento de um carrinho' }),
    (0, swagger_1.ApiOkResponse)({ description: 'Sucesso' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [cart_dto_1.CartDto]),
    __metadata("design:returntype", void 0)
], CartController.prototype, "closeCart", null);
